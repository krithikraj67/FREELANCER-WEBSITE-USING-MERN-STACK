...
export default function Home() {
  ...
  return (
    <div className="Home">
          ...
          <div className="about-us" id="aboutus">
            ...
            <div className="about-us-description reverse">
              ...
              <div className="about-us-info" data-aos="fade-right">
                At Work Wonders, our team is dedicated to making sure that every
      ...
      <footer>
        <div className="footer-head">WorkWonders</div>
        <p className="footer-body">
          Work Wonders is a leading provider of freelance services, connecting
