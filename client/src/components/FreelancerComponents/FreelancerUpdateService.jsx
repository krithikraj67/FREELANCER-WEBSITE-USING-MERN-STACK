...
export default function FreelancerUpdateService() {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      if (
        myForm.image.length == 0 ||
        myForm.image.length < 3 ||
        myForm.image.length > 6
      ) {
      ...
      if (err.length != 0) {
        ...
        dispatch(updateService({ serviceId, body }))
          .unwrap()
          .then((data) => {
            setTimeout(() => {
              setLoading(false);
        ...
        <div className="container">
          <div className="section">
            <HashLink
              ...
              to={`/dashboard/freelancer/${id}/services/manage`}
            >
              <button>Go Back</button>
            </HashLink>
            <div className="updateHeader">Update Service</div>
            <form
            ...
            >
              <div className="form-section">
                ...
                <input
                  type="text"
                  name="gig"
                  placeholder="Ex:Create a WordPress Website"
